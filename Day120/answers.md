...
**Unicode, encodings and normalisation** — the classic failure is:
...
The example for **Case folding trade-offs** is `examples/03_case_folding_trade_offs.py`.
...
**Handling code-mixed text** in one line: Accuracy hides everything on imbalanced data.
...
For **A reusable text cleaning function**, check in this order:
