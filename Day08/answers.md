...
**Series vs DataFrame vs ndarray** — the classic failure is:
...
The example for **head, info, describe, dtypes** is `examples/03_head_info_describe_dtypes.py`.
...
**Adding and dropping columns** in one line: A DataFrame is a table with labelled columns and an index.
...
For **Writing results back to disk**, check in this order:
