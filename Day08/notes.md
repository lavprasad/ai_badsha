...
Practice: open `examples/01_series_vs_dataframe_vs_ndarray.py`, predict the output, change one line, predict again.
...
Practice: open `examples/02_reading_csv_excel_and_json.py`, predict the output, change one line, predict again.
...
Practice: open `examples/03_head_info_describe_dtypes.py`, predict the output, change one line, predict again.
...
Practice: open `examples/04_selecting_columns_and_rows.py`, predict the output, change one line, predict again.
...
Practice: open `examples/05_loc_vs_iloc.py`, predict the output, change one line, predict again.
...
Practice: open `examples/06_boolean_filtering.py`, predict the output, change one line, predict again.
...
Practice: open `examples/07_adding_and_dropping_columns.py`, predict the output, change one line, predict again.
...
Practice: open `examples/08_the_index_and_reset_index.py`, predict the output, change one line, predict again.
...
Practice: open `examples/09_settingwithcopywarning_explained.py`, predict the output, change one line, predict again.
...
Practice: open `examples/10_writing_results_back_to_disk.py`, predict the output, change one line, predict again.
