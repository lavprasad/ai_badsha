...
**Why dense layers fail on images** — the classic failure is:
...
The example for **Kernels, stride and padding** is `examples/03_kernels_stride_and_padding.py`.
...
**Parameter sharing and translation equivariance** in one line: The mean is pulled around by outliers; the median is not.
...
For **Implementing a conv by hand**, check in this order:
