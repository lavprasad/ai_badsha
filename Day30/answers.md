...
**Frequentist vs Bayesian views** — the classic failure is:
...
The example for **Conjugate priors: Beta-Binomial** is `examples/03_conjugate_priors_beta_binomial.py`.
...
**Naive Bayes as a Bayesian classifier** in one line: Bayes' rule updates a belief with evidence: posterior = likelihood x prior / evidence.
...
For **A Beta-Binomial update in code**, check in this order:
