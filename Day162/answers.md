...
**The trust boundary in an LLM app** — the classic failure is:
...
The example for **Indirect injection via documents and web pages** is `examples/03_indirect_injection_via_documents_and_web.py`.
...
**Authorisation in code, not prompts** in one line: Retrieved documents, web pages and user files are untrusted input.
...
For **A threat model for your app**, check in this order:
