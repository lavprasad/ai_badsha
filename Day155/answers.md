...
**Prompt template for grounded answers** — the classic failure is:
...
The example for **Instructing abstention** is `examples/03_instructing_abstention.py`.
...
**Context ordering effects** in one line: RAG grounds answers in your documents: chunk, embed, store, retrieve the top-k for the question, and put them in the prompt.
...
For **Measuring groundedness**, check in this order:
