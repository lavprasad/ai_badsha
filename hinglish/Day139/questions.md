...
Koi **Tokenisation cost across scripts** ke liye code likhta hai aur production me bug aa jaata hai.
...
`examples/` me **Cross-lingual transfer** wali file bina chalaye padho.
...
**Code-mixed Hinglish text** ka rule hai:

> Per request tokens apne users ki asli bhasha me naapo, English me nahi.
...
Aap ek asli system bana rahe ho aur **Low-resource language strategies** vichaar me hai.
...
Aapke colleague ka **Building for Indian language users** wala code aise results de raha hai jo theek lagte hain par galat hain.
