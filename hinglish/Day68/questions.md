...
Koi **Prediction vs intervention** ke liye code likhta hai aur production me bug aa jaata hai.
...
`examples/` me **Randomised experiments as the gold standard** wali file bina chalaye padho.
...
**Difference-in-differences** ka rule hai:

> Kisi bhi observational effect ka matlab nikalne se pehle confounders ka naam lo. Naam na le sako to causality ka daawa mat karo.
...
Aap ek asli system bana rahe ho aur **Directed acyclic graphs** vichaar me hai.
...
Aapke colleague ka **Asking causal questions honestly** wala code aise results de raha hai jo theek lagte hain par galat hain.
