...
**Tensors and dtypes** — classic failure ye hai:
...
**CPU and GPU devices** wali file `examples/03_cpu_and_gpu_devices.py` hai.
...
**nn.Module and parameters** ek line me: PyTorch matlab NumPy + gradients + GPU.
...
**Common PyTorch error messages** ke liye is kram me check karo:
