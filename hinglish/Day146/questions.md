...
Koi **A prompt is a specification** ke liye code likhta hai aur production me bug aa jaata hai.
...
`examples/` me **Zero-shot vs few-shot** wali file bina chalaye padho.
...
**Delimiters and structure** ka rule hai:
...
Aap ek asli system bana rahe ho aur **Chain-of-thought when useful** vichaar me hai.
...
Aapke colleague ka **Versioning prompts like code** wala code aise results de raha hai jo theek lagte hain par galat hain.
