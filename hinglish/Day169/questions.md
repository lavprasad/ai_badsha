...
Koi **Document ingestion pipeline** ke liye code likhta hai aur production me bug aa jaata hai.
...
`examples/` me **PDF text vs scanned PDF** wali file bina chalaye padho.
...
**Layout and reading order** ka rule hai:

> Extracted fields par arithmetic aur schema checks wo OCR errors pakadte hain jinhe koi confidence score flag nahi karta.
...
Aap ek asli system bana rahe ho aur **Metadata and provenance** vichaar me hai.
...
Aapke colleague ka **A document intelligence service** wala code aise results de raha hai jo theek lagte hain par galat hain.
