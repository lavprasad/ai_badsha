...
**Sequential data and order** — classic failure ye hai:
...
**Backpropagation through time** wali file `examples/03_backpropagation_through_time.py` hai.
...
Khud ko jis idea par jaanchna hai: Haath se likhe backward pass ko bharosa karne se pehle numeric estimate se gradient-check karo.
...
**Bidirectional RNNs** ek line me: RNN hidden state ko sequence ke saath aage le jaata hai, isliye order maayne rakhta hai.
...
**Why transformers replaced them** ke liye is kram me check karo:
