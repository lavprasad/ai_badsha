...
Koi **Unit tests for transforms** ke liye code likhta hai aur production me bug aa jaata hai.
...
`examples/` me **Model contract tests: shape and range** wali file bina chalaye padho.
...
**Metamorphic testing** ka rule hai:

> Randomness chhoone wale har test ko explicit seed milna chahiye. Parallelism ke neeche global seeding kaafi nahi hai.
...
Aap ek asli system bana rahe ho aur **Testing training runs cheaply** vichaar me hai.
...
Aapke colleague ka **A test suite you actually run** wala code aise results de raha hai jo theek lagte hain par galat hain.
