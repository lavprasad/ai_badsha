...
Koi **Semantic vs instance vs panoptic** ke liye code likhta hai aur production me bug aa jaata hai.
...
`examples/` me **U-Net architecture** wali file bina chalaye padho.
...
**Dice and IoU losses** ka rule hai:

> IoU >= 0.5 aam 'sahi detection' threshold hai; accuracy nahi, mAP report karo.
...
Aap ek asli system bana rahe ho aur **Segment Anything and promptable segmentation** vichaar me hai.
...
Aapke colleague ka **Evaluating segmentation quality** wala code aise results de raha hai jo theek lagte hain par galat hain.
