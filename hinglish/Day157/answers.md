...
**What makes something an agent** — classic failure ye hai:
...
**Tool definitions and schemas** wali file `examples/03_tool_definitions_and_schemas.py` hai.
...
**State between steps** ek line me: Agent ek loop hai: model tool chunta hai, aapka code use chalata hai, result wapas context me jaata hai, aur ye dohraata hai jab tak kaam poora na ho.
...
**Building a two-tool agent from scratch** ke liye is kram me check karo:
