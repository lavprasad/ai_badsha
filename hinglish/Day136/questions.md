...
Koi **Fluency versus factuality** ke liye code likhta hai aur production me bug aa jaata hai.
...
`examples/` me **Grounding in sources** wali file bina chalaye padho.
...
**Self-consistency sampling** ka rule hai:
...
Aap ek asli system bana rahe ho aur **Abstaining when uncertain** vichaar me hai.
...
Aapke colleague ka **Designing for graceful wrongness** wala code aise results de raha hai jo theek lagte hain par galat hain.
