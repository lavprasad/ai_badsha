...
Koi **Query, key, value projections** ke liye code likhta hai aur production me bug aa jaata hai.
...
`examples/` me **Causal and padding masks** wali file bina chalaye padho.
...
**Attention complexity in sequence length** ka rule hai:

> 1/sqrt(d) wala scale sajावat nahi hai — uske bina softmax saturate ho jaata hai aur gradients mar jaate hain.
...
Aap ek asli system bana rahe ho aur **Sliding window and sparse attention** vichaar me hai.
...
Aapke colleague ka **Implementing multi-head attention** wala code aise results de raha hai jo theek lagte hain par galat hain.
