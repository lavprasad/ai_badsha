...
Koi **Why pretrained features transfer** ke liye code likhta hai aur production me bug aa jaata hai.
...
`examples/` me **Fine-tuning: unfreeze at a low LR** wali file bina chalaye padho.
...
**Discriminative learning rates per layer** ka rule hai:

> Har epoch shuffle karo, warna model aapki file ka order seekh lega.
...
Aap ek asli system bana rahe ho aur **Domain gap and when transfer fails** vichaar me hai.
...
Aapke colleague ka **Fine-tuning on a few hundred images** wala code aise results de raha hai jo theek lagte hain par galat hain.
