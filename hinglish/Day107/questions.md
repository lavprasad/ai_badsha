...
Koi **Detection vs classification** ke liye code likhta hai aur production me bug aa jaata hai.
...
`examples/` me **Intersection over union** wali file bina chalaye padho.
...
**Two-stage detectors: R-CNN family** ka rule hai:
...
Aap ek asli system bana rahe ho aur **Non-maximum suppression** vichaar me hai.
...
Aapke colleague ka **Fine-tuning a detector** wala code aise results de raha hai jo theek lagte hain par galat hain.
