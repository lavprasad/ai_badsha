...
Koi **List comprehensions** ke liye code likhta hai aur production me bug aa jaata hai.
...
`examples/` me **Generators and yield** wali file bina chalaye padho.
...
**map, filter and lambda** ka rule hai:

> `Counter` aur `defaultdict` wo zyadatar bookkeeping code hata dete hain jo log haath se likhte hain.
...
Aap ek asli system bana rahe ho aur **collections: Counter, defaultdict** vichaar me hai.
...
Aapke colleague ka **Choosing the right container** wala code aise results de raha hai jo theek lagte hain par galat hain.
