...
**Why RAG instead of fine-tuning** — classic failure ye hai:
...
**Document loading and parsing** wali file `examples/03_document_loading_and_parsing.py` hai.
...
**Storing vectors with metadata** ek line me: Vector numbers ki list hai jiski ek direction aur lambai hoti hai.
...
**A minimal RAG in 50 lines** ke liye is kram me check karo:
