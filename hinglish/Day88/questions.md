...
Koi **Why dense layers fail on images** ke liye code likhta hai aur production me bug aa jaata hai.
...
`examples/` me **Kernels, stride and padding** wali file bina chalaye padho.
...
**Receptive field** ka rule hai:

> Output size = (in - kernel + 2*pad)/stride + 1. Jab layer jud na rahi ho to shapes print karo.
...
Aap ek asli system bana rahe ho aur **Parameter sharing and translation equivariance** vichaar me hai.
...
Aapke colleague ka **Implementing a conv by hand** wala code aise results de raha hai jo theek lagte hain par galat hain.
