...
Koi **Train, validation and test roles** ke liye code likhta hai aur production me bug aa jaata hai.
...
`examples/` me **Stratified split for imbalance** wali file bina chalaye padho.
...
**Time-based split for temporal data** ka rule hai:

> Ek entity split ke theek ek hi taraf honi chahiye. Overlap check karo, maan mat lo.
...
Aap ek asli system bana rahe ho aur **Stratified and grouped K-fold** vichaar me hai.
...
Aapke colleague ka **Locking the test set away** wala code aise results de raha hai jo theek lagte hain par galat hain.
