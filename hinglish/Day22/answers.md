...
**Discrete vs continuous distributions** — classic failure ye hai:
...
**Poisson for counts** wali file `examples/03_poisson_for_counts.py` hai.
...
**Multivariate Gaussian and covariance** ek line me: Bayes rule evidence ke saath belief update karta hai: posterior = likelihood x prior / evidence.
...
**How the likelihood picks your loss function** ke liye is kram me check karo:
