...
Koi **What to log for every call** ke liye code likhta hai aur production me bug aa jaata hai.
...
`examples/` me **Token and cost accounting** wali file bina chalaye padho.
...
**Tracing multi-step chains** ka rule hai:
...
Aap ek asli system bana rahe ho aur **Sampling and retention policies** vichaar me hai.
...
Aapke colleague ka **Building a minimal trace viewer** wala code aise results de raha hai jo theek lagte hain par galat hain.
