...
Koi **Overfitting in high-capacity models** ke liye code likhta hai aur production me bug aa jaata hai.
...
`examples/` me **Dropout** wali file bina chalaye padho.
...
**Early stopping** ka rule hai:

> Regularise karne se pehle features scale karo, warna penalty usi column ko sazaa deta hai jiski units chhoti hain.
...
Aap ek asli system bana rahe ho aur **Label smoothing** vichaar me hai.
...
Aapke colleague ka **Choosing regularisation by symptom** wala code aise results de raha hai jo theek lagte hain par galat hain.
