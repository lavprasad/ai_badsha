...
Koi **Classes and instances** ke liye code likhta hai aur production me bug aa jaata hai.
...
`examples/` me **Dunder methods: __repr__, __len__** wali file bina chalaye padho.
...
**Inheritance vs composition** ka rule hai:

> Dataclass me mutable defaults ko `field(default_factory=...)` chahiye, literal nahi.
...
Aap ek asli system bana rahe ho aur **Custom exception classes** vichaar me hai.
...
Aapke colleague ka **Writing code your future self can read** wala code aise results de raha hai jo theek lagte hain par galat hain.
