...
**What a calibrated probability means** — classic failure ye hai:
...
**Brier score** wali file `examples/03_brier_score.py` hai.
...
**Calibration under class imbalance** ek line me: Bayes rule evidence ke saath belief update karta hai: posterior = likelihood x prior / evidence.
...
**Expected value of a decision** ke liye is kram me check karo:
