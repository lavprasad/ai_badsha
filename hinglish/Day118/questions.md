...
Koi **Requirements: accuracy, latency, cost** ke liye code likhta hai aur production me bug aa jaata hai.
...
`examples/` me **Annotation strategy and quality control** wali file bina chalaye padho.
...
**Handling class imbalance in vision** ka rule hai:

> `Handling class imbalance in vision` use karne se pehle ek assumption likho jo ye aapke data ke baare me maanta hai.
...
Aap ek asli system bana rahe ho aur **Human-in-the-loop review** vichaar me hai.
...
Aapke colleague ka **Writing the system design document** wala code aise results de raha hai jo theek lagte hain par galat hain.
