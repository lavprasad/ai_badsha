...
**What a vector represents in ML** — classic failure ye hai:
...
**The dot product and its meaning** wali file `examples/03_the_dot_product_and_its_meaning.py` hai.
...
**Orthogonality and projection** ek line me: Vector numbers ki list hai jiski ek direction aur lambai hoti hai.
...
**Implementing vector ops in NumPy** ke liye is kram me check karo:
