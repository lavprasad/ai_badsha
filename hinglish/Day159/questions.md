...
Koi **Explicit planning steps** ke liye code likhta hai aur production me bug aa jaata hai.
...
`examples/` me **Subagents and delegation** wali file bina chalaye padho.
...
**Context management across long runs** ka rule hai:
...
Aap ek asli system bana rahe ho aur **Detecting loops and stalls** vichaar me hai.
...
Aapke colleague ka **Evaluating agent trajectories** wala code aise results de raha hai jo theek lagte hain par galat hain.
