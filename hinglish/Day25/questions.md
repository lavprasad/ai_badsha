...
Koi **Framing a decision as an experiment** ke liye code likhta hai aur production me bug aa jaata hai.
...
`examples/` me **Choosing a primary metric** wali file bina chalaye padho.
...
**Deciding sample size up front** ka rule hai:

> Sample size aur metric data dekhne se PEHLE decide karo.
...
Aap ek asli system bana rahe ho aur **Guardrail metrics** vichaar me hai.
...
Aapke colleague ka **When an A/B test is the wrong tool** wala code aise results de raha hai jo theek lagte hain par galat hain.
