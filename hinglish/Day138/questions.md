...
Koi **Turns, roles and system prompts** ke liye code likhta hai aur production me bug aa jaata hai.
...
`examples/` me **Context window management** wali file bina chalaye padho.
...
**Persona and tone control** ka rule hai:

> Correction ko overwrite karna chahiye, saath rehna nahi. Do ulti memories dono retrieve ho jaayengi.
...
Aap ek asli system bana rahe ho aur **Escalation to a human** vichaar me hai.
...
Aapke colleague ka **Building a grounded support bot** wala code aise results de raha hai jo theek lagte hain par galat hain.
