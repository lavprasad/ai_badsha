...
**Categories of harmful content** — classic failure ye hai:
...
**Refusal design that stays useful** wali file `examples/03_refusal_design_that_stays_useful.py` hai.
...
**Red-teaming your own app** ek line me: Retrieved documents, web pages aur user files untrusted input hain.
...
**Balancing safety and usefulness** ke liye is kram me check karo:
