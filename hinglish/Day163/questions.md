...
Koi **Categories of harmful content** ke liye code likhta hai aur production me bug aa jaata hai.
...
`examples/` me **Refusal design that stays useful** wali file bina chalaye padho.
...
**Age and jurisdiction constraints** ka rule hai:
...
Aap ek asli system bana rahe ho aur **Red-teaming your own app** vichaar me hai.
...
Aapke colleague ka **Balancing safety and usefulness** wala code aise results de raha hai jo theek lagte hain par galat hain.
