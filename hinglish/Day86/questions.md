...
Koi **Train and validation phases** ke liye code likhta hai aur production me bug aa jaata hai.
...
`examples/` me **torch.no_grad() for inference** wali file bina chalaye padho.
...
**Checkpointing and resuming** ka rule hai:

> Har step me pehle `opt.zero_grad()`. PyTorch design se hi gradients jodta hai.
...
Aap ek asli system bana rahe ho aur **Gradient clipping** vichaar me hai.
...
Aapke colleague ka **A reusable Trainer you actually own** wala code aise results de raha hai jo theek lagte hain par galat hain.
