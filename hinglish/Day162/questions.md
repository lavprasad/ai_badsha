...
Koi **The trust boundary in an LLM app** ke liye code likhta hai aur production me bug aa jaata hai.
...
`examples/` me **Indirect injection via documents and web pages** wali file bina chalaye padho.
...
**Confused deputy problems** ka rule hai:

> Untrusted content ko delimit karo aur authorisation code me lagu karo — prompt security boundary nahi hai.
...
Aap ek asli system bana rahe ho aur **Authorisation in code, not prompts** vichaar me hai.
...
Aapke colleague ka **A threat model for your app** wala code aise results de raha hai jo theek lagte hain par galat hain.
