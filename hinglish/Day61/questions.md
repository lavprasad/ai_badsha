...
Koi **Framing: rare, unlabelled, costly** ke liye code likhta hai aur production me bug aa jaata hai.
...
`examples/` me **Isolation Forest** wali file bina chalaye padho.
...
**Local Outlier Factor** ka rule hai:
...
Aap ek asli system bana rahe ho aur **Time-series anomaly detection** vichaar me hai.
...
Aapke colleague ka **A server-metrics anomaly detector** wala code aise results de raha hai jo theek lagte hain par galat hain.
