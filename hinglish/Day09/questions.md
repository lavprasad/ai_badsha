...
Koi **groupby: split, apply, combine** ke liye code likhta hai aur production me bug aa jaata hai.
...
`examples/` me **agg with multiple functions** wali file bina chalaye padho.
...
**concat for stacking frames** ka rule hai:
...
Aap ek asli system bana rahe ho aur **melt: wide to long** vichaar me hai.
...
Aapke colleague ka **Chaining without losing readability** wala code aise results de raha hai jo theek lagte hain par galat hain.
