...
Koi **One-hot encoding** ke liye code likhta hai aur production me bug aa jaata hai.
...
`examples/` me **Target encoding and its leakage risk** wali file bina chalaye padho.
...
**Handling unseen categories at inference** ka rule hai:

> Pehle profile karo. GPU 30% utilisation par matlab bottleneck data pipeline hai, GPU nahi.
...
Aap ek asli system bana rahe ho aur **RobustScaler for outlier-heavy data** vichaar me hai.
...
Aapke colleague ka **Fitting transforms on train only** wala code aise results de raha hai jo theek lagte hain par galat hain.
