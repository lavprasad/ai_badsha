...
Koi **Token economics** ke liye code likhta hai aur production me bug aa jaata hai.
...
`examples/` me **Prompt caching** wali file bina chalaye padho.
...
**Small model first, escalate on failure** ka rule hai:

> Failure path ki keemat hamesha jodo. Human escalation aam taur par table ke har model cost par bhaari padta hai.
...
Aap ek asli system bana rahe ho aur **Caching identical requests** vichaar me hai.
...
Aapke colleague ka **A cost dashboard for your app** wala code aise results de raha hai jo theek lagte hain par galat hain.
