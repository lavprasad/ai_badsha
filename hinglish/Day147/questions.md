...
Koi **Decomposition into sub-prompts** ke liye code likhta hai aur production me bug aa jaata hai.
...
`examples/` me **Self-critique and revision loops** wali file bina chalaye padho.
...
**Persona and expertise framing** ka rule hai:

> Output format sabse aakhir me rakho aur use example ki tarah dikhao — models sabse paas wala pattern copy karte hain.
...
Aap ek asli system bana rahe ho aur **Refusal and safe-completion design** vichaar me hai.
...
Aapke colleague ka **A prompt library with tests** wala code aise results de raha hai jo theek lagte hain par galat hain.
