...
Koi **Choosing a paper with released code or clear method** ke liye code likhta hai aur production me bug aa jaata hai.
...
`examples/` me **Restating the core idea in one paragraph** wali file bina chalaye padho.
...
**Reproducing the headline number** ka rule hai:

> Data contract test karo, sirf function nahi — kharab data kharab code se zyada models todta hai.
...
Aap ek asli system bana rahe ho aur **Ablating the key component** vichaar me hai.
...
Aapke colleague ka **Publishing the repository** wala code aise results de raha hai jo theek lagte hain par galat hain.
