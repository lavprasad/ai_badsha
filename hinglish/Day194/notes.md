...
Aaj ka goal: **CAPSTONE 3: research replication** ko aasaan Hinglish me samajhna — das concepts, das chalne wale examples, paanch sawaal.
...
Practice: `examples/01_choosing_a_paper_with_released_code_or_c.py` kholo, output predict karo, ek line badlo, phir se predict karo.
...
Practice: `examples/02_reading_it_with_the_three_pass_method.py` kholo, output predict karo, ek line badlo, phir se predict karo.
...
Practice: `examples/03_restating_the_core_idea_in_one_paragraph.py` kholo, output predict karo, ek line badlo, phir se predict karo.
...
Practice: `examples/04_minimal_reimplementation.py` kholo, output predict karo, ek line badlo, phir se predict karo.
...
Practice: `examples/05_reproducing_the_headline_number.py` kholo, output predict karo, ek line badlo, phir se predict karo.
...
Practice: `examples/06_where_your_numbers_differ_and_why.py` kholo, output predict karo, ek line badlo, phir se predict karo.
...
Practice: `examples/07_ablating_the_key_component.py` kholo, output predict karo, ek line badlo, phir se predict karo.
...
Practice: `examples/08_extending_it_by_one_small_idea.py` kholo, output predict karo, ek line badlo, phir se predict karo.
...
Practice: `examples/09_documenting_honestly_including_failures.py` kholo, output predict karo, ek line badlo, phir se predict karo.
...
Practice: `examples/10_publishing_the_repository.py` kholo, output predict karo, ek line badlo, phir se predict karo.

---

## Day 194 ke baad aapko ye aana chahiye

- **Choosing a paper with released code or clear method** ko bina notes dekhe kisi dost ko samjha sakna.
- **Reading it with the three-pass method** ko bina notes dekhe kisi dost ko samjha sakna.
- **Restating the core idea in one paragraph** ko bina notes dekhe kisi dost ko samjha sakna.
- **Minimal reimplementation** ko bina notes dekhe kisi dost ko samjha sakna.
- **Reproducing the headline number** ko bina notes dekhe kisi dost ko samjha sakna.
