...
Koi **Choosing a feature worth AI** ke liye code likhta hai aur production me bug aa jaata hai.
...
`examples/` me **Progressive disclosure of AI output** wali file bina chalaye padho.
...
**Explaining what the AI did** ka rule hai:
...
Aap ek asli system bana rahe ho aur **Onboarding users to a fuzzy tool** vichaar me hai.
...
Aapke colleague ka **Knowing when to remove the AI** wala code aise results de raha hai jo theek lagte hain par galat hain.
