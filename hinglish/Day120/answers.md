...
**Unicode, encodings and normalisation** — classic failure ye hai:
...
**Case folding trade-offs** wali file `examples/03_case_folding_trade_offs.py` hai.
...
**Handling code-mixed text** ek line me: Imbalanced data par accuracy sab chhupa leti hai.
...
**A reusable text cleaning function** ke liye is kram me check karo:
