...
Koi **The computational graph** ke liye code likhta hai aur production me bug aa jaata hai.
...
`examples/` me **The chain rule, backwards** wali file bina chalaye padho.
...
**Backprop through a two-layer network** ka rule hai:

> Haath se likhe backward pass ko bharosa karne se pehle numeric estimate se gradient-check karo.
...
Aap ek asli system bana rahe ho aur **Gradient checking** vichaar me hai.
...
Aapke colleague ka **Implementing a full training loop in NumPy** wala code aise results de raha hai jo theek lagte hain par galat hain.
