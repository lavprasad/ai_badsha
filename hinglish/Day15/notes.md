...
Aaj ka goal: **PROJECT: dataset explorer CLI** ko aasaan Hinglish me samajhna — das concepts, das chalne wale examples, paanch sawaal.
...
Practice: `examples/01_framing_the_tool_what_question_does_it_a.py` kholo, output predict karo, ek line badlo, phir se predict karo.
...
Practice: `examples/02_loading_any_csv_robustly.py` kholo, output predict karo, ek line badlo, phir se predict karo.
...
Practice: `examples/03_auto_detecting_column_types.py` kholo, output predict karo, ek line badlo, phir se predict karo.
...
Practice: `examples/04_null_and_cardinality_report.py` kholo, output predict karo, ek line badlo, phir se predict karo.
...
Practice: `examples/05_summary_statistics_per_column_type.py` kholo, output predict karo, ek line badlo, phir se predict karo.
...
Practice: `examples/06_correlation_with_the_target_column.py` kholo, output predict karo, ek line badlo, phir se predict karo.
...
Practice: `examples/07_generating_plots_to_a_folder.py` kholo, output predict karo, ek line badlo, phir se predict karo.
...
Practice: `examples/08_command_line_arguments_with_argparse.py` kholo, output predict karo, ek line badlo, phir se predict karo.
...
Practice: `examples/09_writing_a_markdown_report_file.py` kholo, output predict karo, ek line badlo, phir se predict karo.
...
Practice: `examples/10_packaging_and_reusing_the_tool.py` kholo, output predict karo, ek line badlo, phir se predict karo.

---

## Day 15 ke baad aapko ye aana chahiye

- **Framing the tool: what question does it answer** ko bina notes dekhe kisi dost ko samjha sakna.
- **Loading any CSV robustly** ko bina notes dekhe kisi dost ko samjha sakna.
- **Auto-detecting column types** ko bina notes dekhe kisi dost ko samjha sakna.
- **Null and cardinality report** ko bina notes dekhe kisi dost ko samjha sakna.
- **Summary statistics per column type** ko bina notes dekhe kisi dost ko samjha sakna.
