...
Koi **Why notebooks do not ship** ke liye code likhta hai aur production me bug aa jaata hai.
...
`examples/` me **Configuration files over hard-coded values** wali file bina chalaye padho.
...
**Logging instead of print** ka rule hai:

> 'Restart kernel and run all' hi ek imaandaar test hai ki notebook sach me chalta hai.
...
Aap ek asli system bana rahe ho aur **Packaging with pyproject.toml** vichaar me hai.
...
Aapke colleague ka **Refactoring a notebook into modules** wala code aise results de raha hai jo theek lagte hain par galat hain.
