...
Koi **The 2017 idea: attention is all you need** ke liye code likhta hai aur production me bug aa jaata hai.
...
`examples/` me **Self-attention block** wali file bina chalaye padho.
...
**Feed-forward network per position** ka rule hai:
...
Aap ek asli system bana rahe ho aur **Encoder stack** vichaar me hai.
...
Aapke colleague ka **Drawing the block from memory** wala code aise results de raha hai jo theek lagte hain par galat hain.
