...
Koi **Goal: raw file to model-ready matrix** ke liye code likhta hai aur production me bug aa jaata hai.
...
`examples/` me **Cleaning stage with logged decisions** wali file bina chalaye padho.
...
**Encoding and scaling inside a Pipeline** ka rule hai:

> `handle_unknown='ignore'` production ko us category par crash hone se bachata hai jo training me kabhi nahi dikhi.
...
Aap ek asli system bana rahe ho aur **Persisting the fitted pipeline** vichaar me hai.
...
Aapke colleague ka **A data card describing the result** wala code aise results de raha hai jo theek lagte hain par galat hain.
