...
**The three things to monitor** — classic failure ye hai:
...
**Prediction drift** wali file `examples/03_prediction_drift.py` hai.
...
**Segment-level monitoring** ek line me: Models sadte hain.

Ise tab use karo jab iski assumptions sach hon aur cost jaayaz ho. Jab na hon to kuch
simple uthao — jo baseline aap samajhte ho wo us fancy method se behtar hai jise aap raat
2 baje debug nahi kar sakte. Sahi jawab *assumption* ka naam leta hai, tool ka nahi.

Dhyaan rakho: Sirf uptime monitor karna, jisse 200 OK lautaata hua bilkul galat model bhi healthy dikhta hai.

---

### A5. Debug karo

**An on-call runbook for a model** ke liye is kram me check karo:
