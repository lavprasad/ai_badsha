...
**Images as patch sequences** — classic failure ye hai:
...
**Positional embeddings for images** wali file `examples/03_positional_embeddings_for_images.py` hai.
...
**Swin and hierarchical attention** ek line me: Clustering bina labels ke points ko group karta hai.
...
**Attention maps as explanation** ke liye is kram me check karo:
