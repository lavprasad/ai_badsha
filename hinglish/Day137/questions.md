...
Koi **Extractive vs abstractive summarisation** ke liye code likhta hai aur production me bug aa jaata hai.
...
`examples/` me **Map-reduce summarisation** wali file bina chalaye padho.
...
**Structured extraction with schemas** ka rule hai:

> Facts structurally extract karo aur prose alag se summarise karo — summarisation sabse pehle numbers khoti hai.
...
Aap ek asli system bana rahe ho aur **Evaluating summaries** vichaar me hai.
...
Aapke colleague ka **A meeting-notes summariser** wala code aise results de raha hai jo theek lagte hain par galat hain.
