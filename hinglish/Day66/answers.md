...
**What makes time series different** — classic failure ye hai:
...
**Stationarity and differencing** wali file `examples/03_stationarity_and_differencing.py` hai.
...
**Prophet-style additive models** ek line me: DataFrame ek table hai jisme labelled columns aur ek index hota hai.
...
**Forecast evaluation and backtesting** ke liye is kram me check karo:
