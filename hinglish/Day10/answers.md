...
**Parsing dates with to_datetime** — classic failure ye hai:
...
**Rolling windows and expanding** wali file `examples/03_rolling_windows_and_expanding.py` hai.
...
**Categorical dtype for memory** ek line me: NumPy numbers ko ek continuous typed block me rakhta hai aur loops C me chalata hai.

Ise tab use karo jab iski assumptions sach hon aur cost jaayaz ho. Jab na hon to kuch
simple uthao — jo baseline aap samajhte ho wo us fancy method se behtar hai jise aap raat
2 baje debug nahi kar sakte. Sahi jawab *assumption* ka naam leta hai, tool ka nahi.

Dhyaan rakho: Python loop me array elements ghumana, vectorised operation use karne ke bajaye.

---

### A5. Debug karo

**A monthly report in 20 lines** ke liye is kram me check karo:
