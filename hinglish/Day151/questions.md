...
Koi **Why free text is hard to use** ke liye code likhta hai aur production me bug aa jaata hai.
...
`examples/` me **Tool/function calling** wali file bina chalaye padho.
...
**Pydantic models for responses** ka rule hai:

> Model se aaye har payload ko schema ke against validate karo, tab hi wo aapke database tak pahuche.
...
Aap ek asli system bana rahe ho aur **Handling partial and malformed output** vichaar me hai.
...
Aapke colleague ka **A robust extraction service** wala code aise results de raha hai jo theek lagte hain par galat hain.
