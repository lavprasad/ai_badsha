...
**When single-GPU stops working** — classic failure ye hai:
...
**Distributed data parallel** wali file `examples/03_distributed_data_parallel.py` hai.
...
**Mixed precision at scale** ek line me: Imbalanced data par accuracy sab chhupa leti hai.
...
**Deciding whether you need any of this** ke liye is kram me check karo:
