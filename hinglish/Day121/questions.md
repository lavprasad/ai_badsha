...
Koi **Why models need tokens, not words** ke liye code likhta hai aur production me bug aa jaata hai.
...
`examples/` me **Character-level trade-offs** wali file bina chalaye padho.
...
**WordPiece and SentencePiece** ka rule hai:

> Lagbhag 1 token ~ 4 English characters; doosri bhashaon me per word tokens kahin zyada lagte hain.
...
Aap ek asli system bana rahe ho aur **Special tokens: BOS, EOS, PAD, UNK** vichaar me hai.
...
Aapke colleague ka **Implementing BPE merges by hand** wala code aise results de raha hai jo theek lagte hain par galat hain.
