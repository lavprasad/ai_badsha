...
Koi **Perceived vs actual latency** ke liye code likhta hai aur production me bug aa jaata hai.
...
`examples/` me **Parallelising independent calls** wali file bina chalaye padho.
...
**Reducing prompt size** ka rule hai:
...
Aap ek asli system bana rahe ho aur **Caching retrieval results** vichaar me hai.
...
Aapke colleague ka **Meeting a latency SLA** wala code aise results de raha hai jo theek lagte hain par galat hain.
