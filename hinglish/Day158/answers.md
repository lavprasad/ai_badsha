...
**Designing a good tool interface** — classic failure ye hai:
...
**Search and retrieval tools** wali file `examples/03_search_and_retrieval_tools.py` hai.
...
**Database query tools with allowlists** ek line me: Agent ek loop hai: model tool chunta hai, aapka code use chalata hai, result wapas context me jaata hai, aur ye dohraata hai jab tak kaam poora na ho.
...
**Testing tools independently** ke liye is kram me check karo:
