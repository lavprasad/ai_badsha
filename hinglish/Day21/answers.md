...
**Sample spaces and events** — classic failure ye hai:
...
**Independence and conditional probability** wali file `examples/03_independence_and_conditional_probability.py` hai.
...
**Random variables** ek line me: Bayes rule evidence ke saath belief update karta hai: posterior = likelihood x prior / evidence.
...
**Monte Carlo estimation** ke liye is kram me check karo:
