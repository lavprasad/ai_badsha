...
Koi **Short-term context vs long-term memory** ke liye code likhta hai aur production me bug aa jaata hai.
...
`examples/` me **Fact extraction and storage** wali file bina chalaye padho.
...
**Structured memory in a database** ka rule hai:

> `Structured memory in a database` use karne se pehle ek assumption likho jo ye aapke data ke baare me maanta hai.
...
Aap ek asli system bana rahe ho aur **Forgetting and expiry** vichaar me hai.
...
Aapke colleague ka **Designing a memory schema** wala code aise results de raha hai jo theek lagte hain par galat hain.
