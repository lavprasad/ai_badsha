...
Koi **Why aggregate metrics hide the problem** ke liye code likhta hai aur production me bug aa jaata hai.
...
`examples/` me **Building an error taxonomy** wali file bina chalaye padho.
...
**Identifying the biggest error bucket** ka rule hai:

> Error buckets ko total errors ke share se rank karo, error rate se nahi — wahi theek karo jo sach me mehnga pad raha hai.
...
Aap ek asli system bana rahe ho aur **Confusion matrix deep dive** vichaar me hai.
...
Aapke colleague ka **Turning error analysis into a backlog** wala code aise results de raha hai jo theek lagte hain par galat hain.
