...
**Encoder-only: BERT** — classic failure ye hai:
...
**Decoder-only: GPT family** wali file `examples/03_decoder_only_gpt_family.py` hai.
...
**Which family for which task** ek line me: Transformer block = attention + feed-forward, dono residual connection aur LayerNorm me lipte hue.
...
**Reading a model card** ke liye is kram me check karo:
