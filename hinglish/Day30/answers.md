...
**Frequentist vs Bayesian views** — classic failure ye hai:
...
**Conjugate priors: Beta-Binomial** wali file `examples/03_conjugate_priors_beta_binomial.py` hai.
...
**Naive Bayes as a Bayesian classifier** ek line me: Bayes rule evidence ke saath belief update karta hai: posterior = likelihood x prior / evidence.
...
**A Beta-Binomial update in code** ke liye is kram me check karo:
