...
**Goal: a working vision service** — classic failure ye hai:
...
**Collecting and annotating data** wali file `examples/03_collecting_and_annotating_data.py` hai.
...
**Inference API around the model** ek line me: Projects wahi jagah hain jahan seekha hua chipakta hai.
...
**Demo and documentation** ke liye is kram me check karo:
