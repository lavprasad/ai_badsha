...
Koi **Code as a modality** ke liye code likhta hai aur production me bug aa jaata hai.
...
`examples/` me **Repository-level context** wali file bina chalaye padho.
...
**Code review assistance** ka rule hai:

> Test failure ka text seedha context me wapas do — wo aapke paas ka sabse high-signal prompt hai.
...
Aap ek asli system bana rahe ho aur **Execution feedback loops** vichaar me hai.
...
Aapke colleague ka **Building a code assistant workflow** wala code aise results de raha hai jo theek lagte hain par galat hain.
