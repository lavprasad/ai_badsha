...
**Picking a problem you care about** — classic failure ye hai:
...
**Data availability check first** wali file `examples/03_data_availability_check_first.py` hai.
...
**Milestones and a thin first slice** ek line me: Projects wahi jagah hain jahan seekha hua chipakta hai.
...
**Writing the project brief** ke liye is kram me check karo:
