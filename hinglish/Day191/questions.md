...
Koi **Picking a problem you care about** ke liye code likhta hai aur production me bug aa jaata hai.
...
`examples/` me **Data availability check first** wali file bina chalaye padho.
...
**Baseline you must beat** ka rule hai:
...
Aap ek asli system bana rahe ho aur **Milestones and a thin first slice** vichaar me hai.
...
Aapke colleague ka **Writing the project brief** wala code aise results de raha hai jo theek lagte hain par galat hain.
