...
Koi **Public dataset sources** ke liye code likhta hai aur production me bug aa jaata hai.
...
`examples/` me **Web scraping ethics and robots.txt** wali file bina chalaye padho.
...
**File formats: CSV, Parquet, JSONL** ka rule hai:

> Merge se pehle aur baad me `df.shape` zaroor check karo — chupke se rows badhna matlab duplicate keys.
...
Aap ek asli system bana rahe ho aur **Data licensing and terms of use** vichaar me hai.
...
Aapke colleague ka **Documenting data provenance** wala code aise results de raha hai jo theek lagte hain par galat hain.
