...
Koi **Goal: a fine-tuned classifier you can defend** ke liye code likhta hai aur production me bug aa jaata hai.
...
`examples/` me **Stratified splits and a locked test set** wali file bina chalaye padho.
...
**Transfer learning with a pretrained backbone** ka rule hai:

> Wahi normalisation statistics use karo jinke saath pretrained model train hua tha.
...
Aap ek asli system bana rahe ho aur **Training loop with checkpointing** vichaar me hai.
...
Aapke colleague ka **A short model card** wala code aise results de raha hai jo theek lagte hain par galat hain.
