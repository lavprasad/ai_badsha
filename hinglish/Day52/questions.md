...
Koi **Splitting to increase purity** ke liye code likhta hai aur production me bug aa jaata hai.
...
`examples/` me **Information gain** wali file bina chalaye padho.
...
**Depth, leaf size and pruning** ka rule hai:

> Ek bina-prune ka tree lagbhag hamesha chhote forest se kharab hota hai — par wo padha ja sakta hai, jo kabhi-kabhi jeet jaata hai.
...
Aap ek asli system bana rahe ho aur **Regression trees** vichaar me hai.
...
Aapke colleague ka **Visualising and exporting a tree** wala code aise results de raha hai jo theek lagte hain par galat hain.
