...
Koi **Dockerising an ML service** ke liye code likhta hai aur production me bug aa jaata hai.
...
`examples/` me **Slim base images** wali file bina chalaye padho.
...
**Environment variables and secrets** ka rule hai:

> `--no-cache-dir` aur slim base images chhoti rakhte hain; chhoti images tez deploy hoti hain.
...
Aap ek asli system bana rahe ho aur **Kubernetes concepts for ML** vichaar me hai.
...
Aapke colleague ka **Deploying to a cloud runtime** wala code aise results de raha hai jo theek lagte hain par galat hain.
