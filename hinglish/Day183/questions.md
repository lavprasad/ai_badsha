...
Koi **What a model incident looks like** ke liye code likhta hai aur production me bug aa jaata hai.
...
`examples/` me **Immediate mitigation: rollback or disable** wali file bina chalaye padho.
...
**Data pipeline failures** ka rule hai:
...
Aap ek asli system bana rahe ho aur **Communication with stakeholders** vichaar me hai.
...
Aapke colleague ka **Reducing mean time to recovery** wala code aise results de raha hai jo theek lagte hain par galat hain.
