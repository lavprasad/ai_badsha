...
Koi **Roles: research, ML engineer, data engineer, product** ke liye code likhta hai aur production me bug aa jaata hai.
...
`examples/` me **Estimating ML work honestly** wali file bina chalaye padho.
...
**Code review for ML** ka rule hai:

> Ranges aur kill criteria do, kabhi bhi aise kaam ki ek fix date nahi jiski feasibility hi unknown hai.
...
Aap ek asli system bana rahe ho aur **Documentation that survives handover** vichaar me hai.
...
Aapke colleague ka **Making a research result shippable** wala code aise results de raha hai jo theek lagte hain par galat hain.
