...
Koi **Variables, types and dynamic typing** ke liye code likhta hai aur production me bug aa jaata hai.
...
`examples/` me **Lists, tuples, sets, dicts** wali file bina chalaye padho.
...
**if/elif/else and truthiness** ka rule hai:

> `if x:` aur `if x is not None:` 0, '' aur khaali containers par alag hain. Soch kar chuno.
...
Aap ek asli system bana rahe ho aur **Functions, arguments and defaults** vichaar me hai.
...
Aapke colleague ka **Reading the standard library docs** wala code aise results de raha hai jo theek lagte hain par galat hain.
