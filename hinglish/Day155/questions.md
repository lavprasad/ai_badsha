...
Koi **Prompt template for grounded answers** ke liye code likhta hai aur production me bug aa jaata hai.
...
`examples/` me **Instructing abstention** wali file bina chalaye padho.
...
**Answer verification against sources** ka rule hai:
...
Aap ek asli system bana rahe ho aur **Context ordering effects** vichaar me hai.
...
Aapke colleague ka **Measuring groundedness** wala code aise results de raha hai jo theek lagte hain par galat hain.
