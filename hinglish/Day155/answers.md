...
**Prompt template for grounded answers** — classic failure ye hai:
...
**Instructing abstention** wali file `examples/03_instructing_abstention.py` hai.
...
**Context ordering effects** ek line me: RAG jawaabon ko aapke documents me jodta hai: chunk karo, embed karo, store karo, sawaal ke liye top-k retrieve karo, aur prompt me daal do.
...
**Measuring groundedness** ke liye is kram me check karo:
