...
Koi **The derivative as a rate of change** ke liye code likhta hai aur production me bug aa jaata hai.
...
`examples/` me **Partial derivatives** wali file bina chalaye padho.
...
**Directional derivatives** ka rule hai:
...
Aap ek asli system bana rahe ho aur **The Jacobian** vichaar me hai.
...
Aapke colleague ka **Hand-deriving a two-layer gradient** wala code aise results de raha hai jo theek lagte hain par galat hain.
