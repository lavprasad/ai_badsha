...
**Text plus image inputs** — classic failure ye hai:

> Image ko galat resolution ya normalisation par dena aur chupchap quality khona.
...
**Document and chart understanding** wali file `examples/03_document_and_chart_understanding.py` hai.
...
**Failure modes on fine detail** ek line me: Multimodal models images aur text ko ek hi shared embedding space me daal dete hain, isliye kutte ki photo 'a dog' shabdon ke paas girti hai.
...
**A screenshot-to-data pipeline** ke liye is kram me check karo:
