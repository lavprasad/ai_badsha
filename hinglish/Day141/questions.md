...
Koi **Text plus image inputs** ke liye code likhta hai aur production me bug aa jaata hai.
...
`examples/` me **Document and chart understanding** wali file bina chalaye padho.
...
**Audio-native models** ka rule hai:
...
Aap ek asli system bana rahe ho aur **Failure modes on fine detail** vichaar me hai.
...
Aapke colleague ka **A screenshot-to-data pipeline** wala code aise results de raha hai jo theek lagte hain par galat hain.
