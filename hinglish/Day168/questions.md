...
Koi **Capturing user feedback** ke liye code likhta hai aur production me bug aa jaata hai.
...
`examples/` me **Building a labelling loop** wali file bina chalaye padho.
...
**Turning corrections into eval cases** ka rule hai:
...
Aap ek asli system bana rahe ho aur **Avoiding feedback loop bias** vichaar me hai.
...
Aapke colleague ka **Designing the loop from day one** wala code aise results de raha hai jo theek lagte hain par galat hain.
