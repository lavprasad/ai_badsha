...
**When a straight line is the right model** — classic failure ye hai:
...
**Interpreting coefficients and units** wali file `examples/03_interpreting_coefficients_and_units.py` hai.
...
**Multicollinearity in real data** ek line me: Linear regression squared error minimise karke seedhi line fit karta hai.
...
**House-price regression walkthrough** ke liye is kram me check karo:
