...
**Figure and Axes: the object API** — classic failure ye hai:
...
**Histograms and density** wali file `examples/03_histograms_and_density.py` hai.
...
**Log scales and when to use them** ek line me: Model se pehle plot karo.
...
**Plot first, model second** ke liye is kram me check karo:
