...
**Retrieval is the bottleneck, not generation** — classic failure ye hai:
...
**Query rewriting** wali file `examples/03_query_rewriting.py` hai.
...
**Reranking with a cross-encoder** ek line me: RAG jawaabon ko aapke documents me jodta hai: chunk karo, embed karo, store karo, sawaal ke liye top-k retrieve karo, aur prompt me daal do.
...
**Building a retrieval eval set** ke liye is kram me check karo:
