...
Koi **Euclidean and Manhattan distance** ke liye code likhta hai aur production me bug aa jaata hai.
...
`examples/` me **Cosine distance vs Euclidean** wali file bina chalaye padho.
...
**Jaccard and set similarity** ka rule hai:

> Dimensions badhne par distance ka spread/mean ratio ghatta hai — nearest neighbour ka matlab hi khatm hone lagta hai.
...
Aap ek asli system bana rahe ho aur **The curse of dimensionality** vichaar me hai.
...
Aapke colleague ka **Distances that power vector search** wala code aise results de raha hai jo theek lagte hain par galat hain.
