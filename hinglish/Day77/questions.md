...
Koi **Why non-linearity is mandatory** ke liye code likhta hai aur production me bug aa jaata hai.
...
`examples/` me **Tanh** wali file bina chalaye padho.
...
**Leaky ReLU and PReLU** ka rule hai:

> Softmax me `exp` se pehle hamesha max ghatao, warna bade logits inf/NaN me overflow kar jaate hain.
...
Aap ek asli system bana rahe ho aur **Softmax for output distributions** vichaar me hai.
...
Aapke colleague ka **Plotting them all and their gradients** wala code aise results de raha hai jo theek lagte hain par galat hain.
