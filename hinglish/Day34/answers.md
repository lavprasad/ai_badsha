...
**Goal: a tiny numeric library you understand fully** — classic failure ye hai:
...
**Numeric gradient utility** wali file `examples/03_numeric_gradient_utility.py` hai.
...
**Logistic regression from scratch** ek line me: Logistic regression linear score ko sigmoid se dabaa kar probability banata hai.
...
**What you now never have to take on faith** ke liye is kram me check karo:
