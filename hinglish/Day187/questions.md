...
Koi **Harms taxonomy for your product** ke liye code likhta hai aur production me bug aa jaata hai.
...
`examples/` me **Fairness definitions and their conflicts** wali file bina chalaye padho.
...
**Transparency and model cards** ka rule hai:
...
Aap ek asli system bana rahe ho aur **Contestability and appeals** vichaar me hai.
...
Aapke colleague ka **Saying no to a bad use case** wala code aise results de raha hai jo theek lagte hain par galat hain.
