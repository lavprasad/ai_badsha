...
Koi **What LLMs are good and bad at** ke liye code likhta hai aur production me bug aa jaata hai.
...
`examples/` me **Task decomposition** wali file bina chalaye padho.
...
**Where to put validation** ka rule hai:

> Model prastaav deta hai; aapka code faisla karta hai. Kisi action se pehle aakhri check model output kabhi na ho.
...
Aap ek asli system bana rahe ho aur **Human-in-the-loop design** vichaar me hai.
...
Aapke colleague ka **Writing an LLM system design doc** wala code aise results de raha hai jo theek lagte hain par galat hain.
