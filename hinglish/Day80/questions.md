...
Koi **Batch, stochastic and mini-batch descent** ke liye code likhta hai aur production me bug aa jaata hai.
...
`examples/` me **Momentum** wali file bina chalaye padho.
...
**AdaGrad and RMSProp** ka rule hai:

> Scratch training ke liye Adam ka default lr 1e-3 accha start hai; fine-tuning ke liye 1e-5 se 5e-5.
...
Aap ek asli system bana rahe ho aur **AdamW and decoupled weight decay** vichaar me hai.
...
Aapke colleague ka **Implementing Adam from scratch** wala code aise results de raha hai jo theek lagte hain par galat hain.
