...
Koi **Inputs, weights, bias** ke liye code likhta hai aur production me bug aa jaata hai.
...
`examples/` me **Activation functions** wali file bina chalaye padho.
...
**XOR and why one layer is not enough** ka rule hai:

> Bina non-linearity ke depth sirf width hai. Check karo ki har hidden layer par activation lagi hai.
...
Aap ek asli system bana rahe ho aur **Matrix form of a layer** vichaar me hai.
...
Aapke colleague ka **A forward pass in pure NumPy** wala code aise results de raha hai jo theek lagte hain par galat hain.
