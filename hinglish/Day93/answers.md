...
**The bottleneck problem in seq2seq** — classic failure ye hai:
...
**Query, key and value** wali file `examples/03_query_key_and_value.py` hai.
...
**Self-attention vs cross-attention** ek line me: Attention har token ko har doosre token ko dekh kar tay karne deta hai ki kya important hai.
...
**Implementing attention in NumPy** ke liye is kram me check karo:
