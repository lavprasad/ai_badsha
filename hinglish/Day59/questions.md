...
Koi **What clustering can and cannot tell you** ke liye code likhta hai aur production me bug aa jaata hai.
...
`examples/` me **Choosing k: elbow and silhouette** wali file bina chalaye padho.
...
**Limitations: shape and scale assumptions** ka rule hai:

> Silhouette 1 ke paas matlab tight, alag-alag clusters; 0 ke paas matlab boundaries bemaani hain.
...
Aap ek asli system bana rahe ho aur **Hierarchical clustering and dendrograms** vichaar me hai.
...
Aapke colleague ka **Customer segmentation walkthrough** wala code aise results de raha hai jo theek lagte hain par galat hain.
