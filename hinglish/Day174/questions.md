...
Koi **Goal: grounded answers over your own documents** ke liye code likhta hai aur production me bug aa jaata hai.
...
`examples/` me **Embedding and index construction** wali file bina chalaye padho.
...
**Grounded generation with citations** ka rule hai:

> Jawab me har retrieved chunk ka source dikhao taaki users use verify kar sakein.
...
Aap ek asli system bana rahe ho aur **Evaluation set and scoring harness** vichaar me hai.
...
Aapke colleague ka **Deploying it behind an API** wala code aise results de raha hai jo theek lagte hain par galat hain.
