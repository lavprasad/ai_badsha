...
**Goal: grounded answers over your own documents** — classic failure ye hai:
...
**Embedding and index construction** wali file `examples/03_embedding_and_index_construction.py` hai.
...
**Evaluation set and scoring harness** ek line me: RAG jawaabon ko aapke documents me jodta hai: chunk karo, embed karo, store karo, sawaal ke liye top-k retrieve karo, aur prompt me daal do.
...
**Deploying it behind an API** ke liye is kram me check karo:
