...
Koi **Face detection vs recognition** ke liye code likhta hai aur production me bug aa jaata hai.
...
`examples/` me **Landmark detection** wali file bina chalaye padho.
...
**Person re-identification** ka rule hai:

> Biometric data aam taur par revoke nahi ho sakta. Use apni sabse sensitive category maano.
...
Aap ek asli system bana rahe ho aur **Privacy and consent** vichaar me hai.
...
Aapke colleague ka **Safer alternatives to face recognition** wala code aise results de raha hai jo theek lagte hain par galat hain.
