...
Koi **Check the data before the model** ke liye code likhta hai aur production me bug aa jaata hai.
...
`examples/` me **Overfit a tiny subset deliberately** wali file bina chalaye padho.
...
**Inspect the loss curve** ka rule hai:

> Initialisation par expected cross-entropy ln(n_classes) hoti hai. Alag value matlab wiring bug.
...
Aap ek asli system bana rahe ho aur **Look at the worst predictions by hand** vichaar me hai.
...
Aapke colleague ka **A systematic debugging checklist** wala code aise results de raha hai jo theek lagte hain par galat hain.
