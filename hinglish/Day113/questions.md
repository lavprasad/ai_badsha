...
Koi **Joint image-text embedding space** ke liye code likhta hai aur production me bug aa jaata hai.
...
`examples/` me **Zero-shot classification** wali file bina chalaye padho.
...
**Image search by description** ka rule hai:

> Zero-shot quality prompt ki wording par bahut depend karti hai — 'a photo of a {}' saade noun se behtar hai.
...
Aap ek asli system bana rahe ho aur **Visual question answering** vichaar me hai.
...
Aapke colleague ka **Building a semantic image search** wala code aise results de raha hai jo theek lagte hain par galat hain.
