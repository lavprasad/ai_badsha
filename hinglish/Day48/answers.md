...
**The confusion matrix** — classic failure ye hai:
...
**Precision and recall** wali file `examples/03_precision_and_recall.py` hai.
...
**Precision-recall curves for imbalance** ek line me: Imbalanced data par accuracy sab chhupa leti hai.
...
**Choosing the metric before the model** ke liye is kram me check karo:
