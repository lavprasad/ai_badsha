...
Koi **The confusion matrix** ke liye code likhta hai aur production me bug aa jaata hai.
...
`examples/` me **Precision and recall** wali file bina chalaye padho.
...
**Specificity and false positive rate** ka rule hai:

> Decision threshold validation data par tune karo; 0.5 ek default hai, decision nahi.
...
Aap ek asli system bana rahe ho aur **Precision-recall curves for imbalance** vichaar me hai.
...
Aapke colleague ka **Choosing the metric before the model** wala code aise results de raha hai jo theek lagte hain par galat hain.
