...
Koi **Why inference cost matters more than training cost** ke liye code likhta hai aur production me bug aa jaata hai.
...
`examples/` me **Post-training vs quantisation-aware training** wali file bina chalaye padho.
...
**Knowledge distillation** ka rule hai:

> Quantise karo, apne khud ke eval set par quality naapo, phir decide karo. Published benchmarks aapka task nahi hain.
...
Aap ek asli system bana rahe ho aur **Operator fusion** vichaar me hai.
...
Aapke colleague ka **Shrinking a model for edge deployment** wala code aise results de raha hai jo theek lagte hain par galat hain.
