...
**Mean, median and mode** — classic failure ye hai:

> 'Outliers' ko apne aap hata dena jabki wahi events aapko predict karne ke liye rakha gaya tha.
...
**Quantiles, percentiles and IQR** wali file `examples/03_quantiles_percentiles_and_iqr.py` hai.
...
**Robust statistics and outliers** ek line me: Mean ko outliers kheench lete hain; median ko nahi.
...
**Summarising a dataset honestly** ke liye is kram me check karo:
