...
Koi **Mean, median and mode** ke liye code likhta hai aur production me bug aa jaata hai.
...
`examples/` me **Quantiles, percentiles and IQR** wali file bina chalaye padho.
...
**Covariance and correlation** ka rule hai:

> Skewed data ke liye median + IQR batao, mean + std sirf roughly symmetric data ke liye.
...
Aap ek asli system bana rahe ho aur **Robust statistics and outliers** vichaar me hai.
...
Aapke colleague ka **Summarising a dataset honestly** wala code aise results de raha hai jo theek lagte hain par galat hain.
