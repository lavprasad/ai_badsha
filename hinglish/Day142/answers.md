...
**Why standard benchmarks mislead** — classic failure ye hai:
...
**Task-specific automatic metrics** wali file `examples/03_task_specific_automatic_metrics.py` hai.
...
**Pairwise comparison and Elo** ek line me: Vibes prompt change se nahi bachte.
...
**An eval harness you run on every change** ke liye is kram me check karo:
