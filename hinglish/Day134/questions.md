...
Koi **Prefill vs decode phases** ke liye code likhta hai aur production me bug aa jaata hai.
...
`examples/` me **Continuous batching** wali file bina chalaye padho.
...
**Quantised inference: GPTQ, AWQ, GGUF** ka rule hai:

> Jahan latency ijaazat de wahan requests batch karo — batch size 1 par GPU throughput dhah jaata hai.
...
Aap ek asli system bana rahe ho aur **Throughput vs latency trade-offs** vichaar me hai.
...
Aapke colleague ka **Choosing hosted vs self-hosted** wala code aise results de raha hai jo theek lagte hain par galat hain.
