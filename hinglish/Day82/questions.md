...
Koi **Why zero initialisation fails** ke liye code likhta hai aur production me bug aa jaata hai.
...
`examples/` me **Xavier/Glorot initialisation** wali file bina chalaye padho.
...
**Batch normalisation** ka rule hai:
...
Aap ek asli system bana rahe ho aur **Layer normalisation** vichaar me hai.
...
Aapke colleague ka **Diagnosing activation blow-up** wala code aise results de raha hai jo theek lagte hain par galat hain.
