...
**Why zero initialisation fails** — classic failure ye hai:
...
**Xavier/Glorot initialisation** wali file `examples/03_xavier_glorot_initialisation.py` hai.
...
**Layer normalisation** ek line me: Vector numbers ki list hai jiski ek direction aur lambai hoti hai.
...
**Diagnosing activation blow-up** ke liye is kram me check karo:
