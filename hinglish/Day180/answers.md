...
**What to record for every run** — classic failure ye hai:
...
**Artefact storage** wali file `examples/03_artefact_storage.py` hai.
...
**Comparing runs** ek line me: Jo experiment aap dobara nahi bana sakte wo kissa hai.
...
**A tracking habit that costs 5 minutes** ke liye is kram me check karo:
