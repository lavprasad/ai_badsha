...
Koi **Goal: beat a strong baseline honestly** ke liye code likhta hai aur production me bug aa jaata hai.
...
`examples/` me **EDA and leakage audit** wali file bina chalaye padho.
...
**Feature engineering iterations** ka rule hai:

> Har banaya hua feature prediction ke waqt us data se calculate hona chahiye jo tab sach me maujood hoga.
...
Aap ek asli system bana rahe ho aur **Cross-validated model comparison** vichaar me hai.
...
Aapke colleague ka **Writing the results as a report** wala code aise results de raha hai jo theek lagte hain par galat hain.
