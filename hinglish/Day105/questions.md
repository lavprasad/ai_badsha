...
Koi **Pixels, channels and bit depth** ke liye code likhta hai aur production me bug aa jaata hai.
...
`examples/` me **Image file formats and compression** wali file bina chalaye padho.
...
**Resizing and interpolation methods** ka rule hai:

> Har model call se pehle channel order (RGB vs BGR) aur value range (0-255 vs 0-1) check karo.
...
Aap ek asli system bana rahe ho aur **Normalisation for pretrained models** vichaar me hai.
...
Aapke colleague ka **Building an image loading utility** wala code aise results de raha hai jo theek lagte hain par galat hain.
