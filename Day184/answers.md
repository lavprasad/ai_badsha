...
**When single-GPU stops working** — the classic failure is:
...
The example for **Distributed data parallel** is `examples/03_distributed_data_parallel.py`.
...
**Mixed precision at scale** in one line: Accuracy hides everything on imbalanced data.
...
For **Deciding whether you need any of this**, check in this order:
