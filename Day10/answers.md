...
**Parsing dates with to_datetime** — the classic failure is:
...
The example for **Rolling windows and expanding** is `examples/03_rolling_windows_and_expanding.py`.
...
**Categorical dtype for memory** in one line: NumPy stores numbers in one contiguous typed block and runs loops in C.

Use it when its assumptions hold and the cost is justified. Reach for something
simpler when they do not — a baseline you understand beats a sophisticated method
you cannot debug at 2am. The right answer names *the assumption*, not the tool.

Watch out for: Looping over array elements in Python instead of using a vectorised operation.

---

### A5. Debug it

For **A monthly report in 20 lines**, check in this order:
