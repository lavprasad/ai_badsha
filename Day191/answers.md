...
**Picking a problem you care about** — the classic failure is:
...
The example for **Data availability check first** is `examples/03_data_availability_check_first.py`.
...
**Milestones and a thin first slice** in one line: Projects are where the learning sticks.
...
For **Writing the project brief**, check in this order:
