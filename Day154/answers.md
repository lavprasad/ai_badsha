...
**Structure-aware chunking** — the classic failure is:
...
The example for **PDF parsing pitfalls** is `examples/03_pdf_parsing_pitfalls.py`.
...
**Parent-document retrieval** in one line: RAG grounds answers in your documents: chunk, embed, store, retrieve the top-k for the question, and put them in the prompt.
...
For **Choosing chunk size empirically**, check in this order:
