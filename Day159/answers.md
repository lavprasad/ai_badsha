...
**Explicit planning steps** — the classic failure is:
...
The example for **Subagents and delegation** is `examples/03_subagents_and_delegation.py`.
...
**Detecting loops and stalls** in one line: An agent is a loop: the model picks a tool, your code runs it, the result goes back into context, repeat until done.
...
For **Evaluating agent trajectories**, check in this order:
