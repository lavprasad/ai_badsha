...
**What an embedding space is** — the classic failure is:
...
The example for **Word2vec: skip-gram and CBOW** is `examples/03_word2vec_skip_gram_and_cbow.py`.
...
**Contrastive learning** in one line: An embedding maps text to a dense vector where nearby means similar in meaning.
...
For **Embeddings as the interface between models**, check in this order:
