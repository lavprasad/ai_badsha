...
Practice: open `examples/01_train_validation_and_test_roles.py`, predict the output, change one line, predict again.
...
Practice: open `examples/02_random_split.py`, predict the output, change one line, predict again.
...
Practice: open `examples/03_stratified_split_for_imbalance.py`, predict the output, change one line, predict again.
...
Practice: open `examples/04_group_split_to_avoid_entity_leakage.py`, predict the output, change one line, predict again.
...
Practice: open `examples/05_time_based_split_for_temporal_data.py`, predict the output, change one line, predict again.
...
Practice: open `examples/06_k_fold_cross_validation.py`, predict the output, change one line, predict again.
...
Practice: open `examples/07_stratified_and_grouped_k_fold.py`, predict the output, change one line, predict again.
...
Practice: open `examples/08_nested_cross_validation.py`, predict the output, change one line, predict again.
...
Practice: open `examples/09_how_many_splits_is_too_many.py`, predict the output, change one line, predict again.
...
Practice: open `examples/10_locking_the_test_set_away.py`, predict the output, change one line, predict again.
