...
**Perceived vs actual latency** — the classic failure is:
...
The example for **Parallelising independent calls** is `examples/03_parallelising_independent_calls.py`.
...
**Caching retrieval results** in one line: Vibes do not survive a prompt change.
...
For **Meeting a latency SLA**, check in this order:
