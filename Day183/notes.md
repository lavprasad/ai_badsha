...
| # | Concept |
|--:|---------|
| 1 | What a model incident looks like |
...
## What you should be able to do after Day 183

- Explain **What a model incident looks like** to someone else without notes.
- Explain **Detection and paging** to someone else without notes.
- Explain **Immediate mitigation: rollback or disable** to someone else without notes.
- Explain **Root cause categories** to someone else without notes.
- Explain **Data pipeline failures** to someone else without notes.
