...
**Hugging Face transformers basics** — the classic failure is:
...
The example for **Adding a classification head** is `examples/03_adding_a_classification_head.py`.
...
**Freezing layers** in one line: Hyperparameters are the settings you choose, not learn.
...
For **A ticket classifier walkthrough**, check in this order:
