...
**What a vector represents in ML** — the classic failure is:
...
The example for **The dot product and its meaning** is `examples/03_the_dot_product_and_its_meaning.py`.
...
**Orthogonality and projection** in one line: A vector is a list of numbers with a direction and length.
...
For **Implementing vector ops in NumPy**, check in this order:
