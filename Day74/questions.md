...
Someone writes code for **Goal: beat a strong baseline honestly** and hits a bug in production.
...
For **Feature engineering iterations** the rule is:
...
You are building a real system and **Cross-validated model comparison** is on the table.
...
A colleague's code involving **Writing the results as a report** produces results that look plausible but are wrong.
