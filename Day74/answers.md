...
**Goal: beat a strong baseline honestly** — the classic failure is:
...
The example for **EDA and leakage audit** is `examples/03_eda_and_leakage_audit.py`.
...
**Cross-validated model comparison** in one line: Projects are where the learning sticks.
...
For **Writing the results as a report**, check in this order:
