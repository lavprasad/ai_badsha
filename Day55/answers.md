...
**Maximum margin classification** — the classic failure is:
...
The example for **The C parameter and soft margins** is `examples/03_the_c_parameter_and_soft_margins.py`.
...
**Gamma and the bias-variance effect** in one line: A vector is a list of numbers with a direction and length.
...
For **When SVMs still win**, check in this order:
