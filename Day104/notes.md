...
- Explain **Goal: a fine-tuned classifier you can defend** to someone else without notes.
- Explain **Dataset collection and cleaning** to someone else without notes.
- Explain **Stratified splits and a locked test set** to someone else without notes.
- Explain **Baseline: logistic regression on embeddings** to someone else without notes.
- Explain **Transfer learning with a pretrained backbone** to someone else without notes.
