...
Someone writes code for **Categories of harmful content** and hits a bug in production.
...
Read the example for **Refusal design that stays useful** in `examples/` without running it.
...
For **Age and jurisdiction constraints** the rule is:
...
You are building a real system and **Red-teaming your own app** is on the table.
...
A colleague's code involving **Balancing safety and usefulness** produces results that look plausible but are wrong.
