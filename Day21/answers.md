...
**Sample spaces and events** — the classic failure is:
...
The example for **Independence and conditional probability** is `examples/03_independence_and_conditional_probability.py`.
...
**Random variables** in one line: Bayes' rule updates a belief with evidence: posterior = likelihood x prior / evidence.
...
For **Monte Carlo estimation**, check in this order:
