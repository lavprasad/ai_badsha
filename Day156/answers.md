...
**What a vector database actually does** — the classic failure is:
...
The example for **HNSW and IVF indexes** is `examples/03_hnsw_and_ivf_indexes.py`.
...
**Options: FAISS, Chroma, Qdrant, pgvector** in one line: A vector is a list of numbers with a direction and length.
...
For **Choosing one for your scale**, check in this order:
