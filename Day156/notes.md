...
| 4 | Recall vs latency tuning |
| 5 | Metadata filtering strategies |
| 6 | Sharding and scale |
| 7 | Options: FAISS, Chroma, Qdrant, pgvector |
| 8 | When Postgres is enough |
| 9 | Index rebuild and update costs |
| 10 | Choosing one for your scale |
...
- Explain **What a vector database actually does** to someone else without notes.
- Explain **Exact vs approximate search** to someone else without notes.
- Explain **HNSW and IVF indexes** to someone else without notes.
- Explain **Recall vs latency tuning** to someone else without notes.
- Explain **Metadata filtering strategies** to someone else without notes.
