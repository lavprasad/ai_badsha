...
- Explain **The confusion matrix** to someone else without notes.
- Explain **Accuracy and its blind spot** to someone else without notes.
- Explain **Precision and recall** to someone else without notes.
- Explain **The F1 score and F-beta** to someone else without notes.
- Explain **Specificity and false positive rate** to someone else without notes.
