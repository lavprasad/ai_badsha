...
**The confusion matrix** — the classic failure is:
...
The example for **Precision and recall** is `examples/03_precision_and_recall.py`.
...
**Precision-recall curves for imbalance** in one line: Accuracy hides everything on imbalanced data.
...
For **Choosing the metric before the model**, check in this order:
