...
**A prompt is a specification** — the classic failure is:
...
The example for **Zero-shot vs few-shot** is `examples/03_zero_shot_vs_few_shot.py`.
...
**Chain-of-thought when useful** in one line: A prompt is a program written in English.
...
For **Versioning prompts like code**, check in this order:
