...
**Why zero initialisation fails** — the classic failure is:
...
The example for **Xavier/Glorot initialisation** is `examples/03_xavier_glorot_initialisation.py`.
...
**Layer normalisation** in one line: A vector is a list of numbers with a direction and length.
...
For **Diagnosing activation blow-up**, check in this order:
