...
Someone writes code for **What 200 days actually gave you** and hits a bug in production.
...
Read the example for **The fundamentals that will not expire** in `examples/` without running it.
...
For **Choosing a specialisation** the rule is:
...
You are building a real system and **Contributing to open source AI** is on the table.
...
A colleague's code involving **Your next 200 days** produces results that look plausible but are wrong.
