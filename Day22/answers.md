...
**Discrete vs continuous distributions** — the classic failure is:
...
The example for **Poisson for counts** is `examples/03_poisson_for_counts.py`.
...
**Multivariate Gaussian and covariance** in one line: Bayes' rule updates a belief with evidence: posterior = likelihood x prior / evidence.
...
For **How the likelihood picks your loss function**, check in this order:
