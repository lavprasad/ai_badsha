...
- Explain **Why standard benchmarks mislead** to someone else without notes.
- Explain **Building a golden dataset** to someone else without notes.
- Explain **Task-specific automatic metrics** to someone else without notes.
- Explain **Exact match and structured checks** to someone else without notes.
- Explain **LLM-as-judge** to someone else without notes.
