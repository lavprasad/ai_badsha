...
**seaborn on top of matplotlib** — the classic failure is:
...
The example for **Pairplots and correlation heatmaps** is `examples/03_pairplots_and_correlation_heatmaps.py`.
...
**Spotting skew and outliers visually** in one line: Plot before you model.
...
For **Building a one-page EDA report**, check in this order:
