...
**Problem framing and metric** — the classic failure is:
...
**Calibration and threshold choice** in one line: Projects are where the learning sticks.
...
For **Write-up with results and limitations**, check in this order:
