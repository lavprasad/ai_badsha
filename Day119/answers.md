...
**Goal: a working vision service** — the classic failure is:
...
The example for **Collecting and annotating data** is `examples/03_collecting_and_annotating_data.py`.
...
**Inference API around the model** in one line: Projects are where the learning sticks.
...
For **Demo and documentation**, check in this order:
