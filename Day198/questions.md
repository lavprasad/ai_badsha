...
Someone writes code for **ML fundamentals questions** and hits a bug in production.
...
Read the example for **Case study and system design rounds** in `examples/` without running it.
...
For **Handling 'why did you choose that' questions** the rule is:

> If you cannot explain why your validation split is honest, you do not own the project yet.
...
You are building a real system and **Statistics and probability questions** is on the table.
...
A colleague's code involving **A four-week preparation plan** produces results that look plausible but are wrong.
